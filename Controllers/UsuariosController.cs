...
namespace Confecciones.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(confeccionesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CodUsuario,Nombre,Apellido,Usuario1,Password")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodUsuario,Nombre,Apellido,Usuario1,Password")] Usuario usuario)
        {
